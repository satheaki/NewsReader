...
public class IndiaNewsFragment extends Fragment {
    ...
    private final String apiUrl="https://newsapi.org/v2/top-headlines?country=in&pageSize=15&sortBy=popularity&apiKey=c1dab8dc05dc40a5898d731a700a605e";
    private final static String TAG= IndiaNewsFragment.class.getSimpleName();

    @SuppressLint("ValidFragment")
    public IndiaNewsFragment(Context context) {
        mContext=context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.india_news_fragment,container,false);
