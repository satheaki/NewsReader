...
public class SportsNewsFragment extends Fragment {
    ...
    private final String apiUrl="https://newsapi.org/v2/top-headlines?category=sports&country=us&pageSize=15&sortBy=popularity&apiKey=c1dab8dc05dc40a5898d731a700a605e";
    private final static String TAG= SportsNewsFragment.class.getSimpleName();

    @SuppressLint("ValidFragment")
    public SportsNewsFragment(Context context) {
        mContext=context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.sports_news_fragment,container,false);
