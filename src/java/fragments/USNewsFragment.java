...
public class USNewsFragment extends Fragment {
    View view;
    Context mContext;
    ...
    private final String apiUrl="https://newsapi.org/v2/top-headlines?country=us&pageSize=15&sortBy=popularity&apiKey=c1dab8dc05dc40a5898d731a700a605e";
    private final static String TAG= USNewsFragment.class.getSimpleName();

    @SuppressLint("ValidFragment")
    public USNewsFragment(Context context) {
        mContext=context;
    }
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view=inflater.inflate(R.layout.us_news_fragment,container,false);
