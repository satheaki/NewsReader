...
public class HeadLineFragment extends Fragment {
    ...
    private final String apiUrl="https://newsapi.org/v2/top-headlines?sources=cnn,the-times-of-india,bbc-news,crypto-coins-news&sortBy=popularity&pageSize=15&apiKey=c1dab8dc05dc40a5898d731a700a605e";
    private final static String TAG= HeadLineFragment.class.getSimpleName();

    @SuppressLint("ValidFragment")
    public HeadLineFragment(Context context) {
        mContext=context;
    }
